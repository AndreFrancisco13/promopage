            ...
            <div className="col-12 col-lg-10">
                ...
                <div className="card-body p-4">
                  ...
                  >
                    ...
                    <p className="mb-2 text-small">
                      A BetLearn compromete-se a disponibilizar a sua aplicação
                      móvel em conformidade com o Decreto-Lei n.º 83/2018, de 19
                      de outubro, que transpõe a Diretiva (UE) 2016/2102 do
                      Parlamento Europeu e do Conselho.
                    </p>
                    <p className="mb-0 text-small">
                      <strong>Objetivo:</strong> Garantir a acessibilidade dos
                      sítios Web e das aplicações móveis para todos os
                      utilizadores.
                    </p>
                  </div>
                </div>
              ...
              <div className="alert alert-custom-success mb-4">
                ...
                <p className="fw-bold mb-2" style={{ color: "#155724" }}>
                  A aplicação móvel BetLearn está PLENAMENTE CONFORME com o
                  Decreto-Lei n.º 83/2018, de 19 de outubro.
                </p>
                <p className="text-small mb-0">
                  Cumprimos integralmente os requisitos de acessibilidade
                  estabelecidos pela legislação portuguesa e europeia.
                </p>
              </div>
              ...
              <Section
                id="elaboracao"
                title="I. ELABORAÇÃO DA PRESENTE DECLARAÇÃO"
                icon={<FileText size={20} />}
              >
                <p className="mb-4">
                  De acordo com o artigo 9.º do Decreto-Lei n.º 83/2018, devem
                  ser adotados os seguintes procedimentos de monitorização:
                </p>
                ...
                <div className="row g-3">
                  <div className="col-md-4">
                    <div className="info-item">
                      ...
                      <p className="text-small mb-0">
                        <strong>Avaliações automáticas</strong> (Obrigatório)
                      </p>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="info-item">
                      ...
                      <p className="text-small mb-0">
                        <strong>Avaliações manuais</strong> (Obrigatório)
                      </p>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="privacy-highlight">
                      ...
                      <p className="text-small mb-0">
                        <strong>Testes com utilizadores</strong> (Recomendado)
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Section
                id="avaliacoes-automaticas"
                title="II. AVALIAÇÕES AUTOMÁTICAS LEVADAS A EFEITO"
                icon={<Settings size={20} />}
              >
                <div className="company-info mb-4">
                  <h3 className="section-subheading">
                    Relatório: Práticas de Acessibilidade Web (WCAG 2.1 do W3C)
                  </h3>
                  ...
                  <div className="alert alert-custom-success mt-3">
                    ...
                    <p className="text-small mb-0">
                      <strong>
                        100% das páginas cumprem o nível AA das WCAG 2.1
                      </strong>{" "}
                      - Todas as páginas avaliadas demonstram conformidade total
              ...
              <Section
                id="avaliacoes-manuais"
                title="III. AVALIAÇÕES MANUAIS LEVADAS A EFEITO"
                icon={<Eye size={20} />}
              >
                <p className="mb-4">
                  A aplicação BetLearn foi avaliada em termos de acessibilidade
                  através de testes manuais, baseando-se em três checklists
                  fundamentais:
                </p>
                ...
                <div className="row g-3 mb-4">
                  <div className="col-md-4">
                    <div className="info-item">
                      ...
                      <p className="text-small mb-0">
                        Navegação, interatividade e funcionalidades
                      </p>
                    </div>
                  </div>
                  <div className="col-md-4">
                    <div className="info-item">
                      ...
                      <p className="text-small mb-0">
                        Legibilidade, estrutura e organização
                      </p>
                    </div>
                  </div>
                  <div className="col-md-4">
              ...
              <Section
                ...
                title="IV. TESTES DE USABILIDADE COM PESSOAS COM DEFICIÊNCIA"
                icon={<Users size={20} />}
              >
                <div className="privacy-highlight">
                  <div className="icon">👥</div>
                  <p className="text-small mb-2">
                    <strong>Estado atual:</strong> A aplicação móvel BetLearn
                    ainda não foi alvo de testes com utilizadores com
                    deficiência.
                  </p>
                  <p className="text-small mb-0">
                    Estamos a planear a implementação destes testes para uma
                    futura versão, visando melhorar continuamente a experiência
              ...
              <Section
                id="contacto-informacao"
                title="V. CONTACTO E SOLICITAÇÃO DE INFORMAÇÃO"
                icon={<Mail size={20} />}
              >
                <p className="mb-4">
                  Para contactar, enviar sugestões, efetuar reclamações ou
                  solicitar informações adicionais relativamente aos conteúdos
                  e/ou funcionalidades da aplicação BetLearn:
                </p>
              ...
              <Section
                id="outras-evidencias"
                title="VI. OUTRAS EVIDÊNCIAS"
                icon={<Database size={20} />}
              >
                <div className="privacy-highlight">
                  <div className="icon">📋</div>
                  <p className="text-small mb-0">
                    Atualmente, não foram apresentadas outras evidências ou
                    esforços adicionais para garantir a conformidade da
                    aplicação com os requisitos de acessibilidade constantes do
                    Decreto-Lei n.º 83/2018, de 19 de outubro.
                  </p>
                </div>
              </Section>
              ...
              <Section
                ...
                title="VII. DENÚNCIA DE SITUAÇÕES DE DISCRIMINAÇÃO"
                isImportant={true}
              ...
              >
                <div className="alert alert-custom-info mb-4">
                  ...
                  <p className="text-small mb-0">
                    De acordo com o artigo 13.º do Decreto-Lei n.º 83/2018, de
                    19 de outubro, qualquer pessoa que seja alvo de
                    discriminação em razão de deficiência pode apresentar queixa
                    através do INR, I.P.
                  </p>
                </div>
                ...
                <div className="company-info mb-3">
                  ...
                  <ul className="text-small mb-3">
                    <li>
                      O INR, I.P. disponibiliza um formulário para denunciar
                      situações de discriminação
                    </li>
                    <li>
                      As queixas apresentadas são encaminhadas às entidades
                      competentes
                    </li>
                    <li>
                      É elaborado anualmente um relatório sobre a aplicação da
                  ...
                  <div className="privacy-highlight">
                    <div className="icon">⚖️</div>
                    <p className="text-small mb-0">
                      <strong>Lei n.º 46/2006:</strong> Proíbe e pune a
                      discriminação em razão da deficiência e do risco agravado
                      de saúde.
                    </p>
                  </div>
                </div>
              ...
              <div className="card shadow-sm mt-4">
                <div className="card-body">
                  ...
                  <p className="mb-4">
                    A BetLearn mantém um compromisso contínuo com a melhoria da
                    acessibilidade e usabilidade da sua aplicação:
                  </p>
                  ...
                  <div className="row g-3">
                    <div className="col-md-6">
                      <div className="info-item">
                        ...
                        <p className="text-small mb-0">
                          Avaliação e atualização regular dos padrões de
                          acessibilidade
                        </p>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="info-item">
                        ...
                        <p className="text-small mb-0">
                          Resposta rápida a questões e sugestões de
                          acessibilidade
                        </p>
                      </div>
                    </div>
              ...
              <div className="footer text-center mt-4">
                <p className="text-small mb-2">
                  Esta declaração de acessibilidade foi atualizada pela última
                  vez em 06 de maio de 2025.
                </p>
                <p className="text-small mb-0" style={{ opacity: 0.8 }}>
                  © 2025 BetLearn. Comprometidos com a acessibilidade para
                  todos.
                </p>
              </div>
            </div>
